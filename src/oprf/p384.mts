import { secp384r1, hashToCurve } from "@noble/curves/p384";
...
export type secp384r1Point = InstanceType<typeof secp384r1.ProjectivePoint>;

const secp384r1Suite: Suite<secp384r1Point> = Object.freeze({
	id: "P384-SHA384",
	curve: secp384r1.CURVE,
	point: secp384r1.ProjectivePoint,
	field: mod.Field(secp384r1.CURVE.n, undefined, false),
	elementSize: 49,
	scalarSize: 48,
	hash: sha384,
	outputSize: 48,
	...
	decodeElement(bytes: Uint8Array): secp384r1Point {
		return secp384r1.ProjectivePoint.fromHex(bytes);
	},
	randomScalar(): bigint {
		const tmp = secp384r1.utils.randomPrivateKey();
		return secp384r1.utils.normPrivateKeyToScalar(tmp);
	},
	encodeScalar(scalar: bigint): Uint8Array {
		return numberToBytesBE(scalar, this.scalarSize);
	},
	decodeScalar(bytes: Uint8Array): bigint {
		return secp384r1.utils.normPrivateKeyToScalar(bytes);
	},
	...
	hashToGroup(msg: Uint8Array, dst: Uint8Array): secp384r1Point {
		...
		return secp384r1.ProjectivePoint.fromAffine(affinePoint);
	},
});
